...
public class TestUnit {
    ...
    public static void main(String[] args) {
        try {
            DbSearcher _searcher = new DbSearcher(new DbConfig(), "C:\\me\\app\\src\\org\\lionsoul\\ip2region\\data\\ip2region.db");
            BufferedReader bfr   = new BufferedReader(new FileReader("C:\\me\\app\\src\\org\\lionsoul\\ip2region\\data\\ip.merge.txt"));
            BufferedWriter bwr   = new BufferedWriter(new FileWriter("C:\\me\\app\\src\\org\\lionsoul\\ip2region\\data\\error_log.txt", true));
            int errCount  = 0;
            int lineCount = 0;
            String str = null;
